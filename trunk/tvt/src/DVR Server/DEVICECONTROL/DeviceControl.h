...
#define TD4408L	 17
#define TD4416L	 18
#define TD4308L	 19 //zld 2009/10/28
#define TD4316L	 20 //zld 2009/10/28
...
//4408
//add 4308 2009/02/27														
#define IS_DSP_PRODUCT(product_type)	(((product_type)==DVR_CARD_TD4104)||((product_type)==DVR_CARD_TD4116)||((product_type)==DVR_CARD_TD4108)||((product_type)==DVR_CARD_TD4408)||((product_type)==DVR_CARD_TD4308))//4408
...
typedef enum _DVRENUM_VIDEO_SIZE_TYPE
{
	...
	DVRVIDEO_SIZE_704x288	= 0x0100,
	DVRVIDEO_SIZE_704x240	= 0x0200
