...
#pragma warning( disable : 4786 )
    ...
    //#define TINYXML_API __declspec(dllimport)
        ...
        #define TINYXML_LINK
            ...
            #pragma comment(lib, "tinyxml_dynamic_debug.lib")
            #pragma message("Automatically linking with tinyxml_dynamic_debug.lib") 
        #elif defined _DEBUG && !defined _DLL
            #pragma comment(lib, "tinyxml_static_debug.lib")
            #pragma message("Automatically linking with tinyxml_static_debug.lib") 
        #elif !defined _DEBUG && defined _DLL
            #pragma comment(lib, "tinyxml_dynamic.lib")
            #pragma message("Automatically linking with tinyxml_dynamic.lib") 
        #else
            #pragma comment(lib, "tinyxml_static.lib")
            #pragma message("Automatically linking with tinyxml_static.lib") 
        #endif // _DEBUG
    #endif
#endif
